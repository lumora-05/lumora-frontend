...
export default function CashierAccount() {
  ...
  const name = profile?.hoTen || profile?.fullName || profile?.username || profile?.tenDangNhap || 'Nhân viên thu ngân';
  ...
  const roleName = profile?.tenVaiTro || profile?.vaiTro?.tenVaiTro || profile?.roleName || 'Nhân viên thu ngân';
  ...
  return (
    <section className="waiter-page kitchen-account-page cashier-account-modern">
        ...
        <section className="kitchen-account-surface waiter-alert-settings">
          <header className="kitchen-account-security-head">
            ...
            <div>
              ...
              <p>Bật cảnh báo để nhận âm thanh và thông báo nhắc việc khi có yêu cầu thanh toán hoặc công việc thu ngân cần xử lý.</p>
            </div>
          </header>
          ...
          <div className="waiter-alert-settings-body">
            <div className="waiter-alert-setting-row">
              <div>
                ...
                <p>Nhận cảnh báo khi có yêu cầu thanh toán, hóa đơn hoặc công việc thu ngân cần xử lý.</p>
              </div>
