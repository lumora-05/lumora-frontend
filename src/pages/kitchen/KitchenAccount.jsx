...
export default function KitchenAccount() {
  ...
  const name = profile?.hoTen || profile?.fullName || profile?.username || profile?.tenDangNhap || 'Nhân viên bếp';
  ...
  const roleName = profile?.tenVaiTro || profile?.vaiTro?.tenVaiTro || profile?.roleName || 'Nhân viên bếp';
  ...
  return (
    <section className="kitchen-page kitchen-account-page">
          ...
          <div className="kitchen-account-profile-content">
            <header className="kitchen-account-section-head">
              <div>
                ...
                <p>Quản lý thông tin liên hệ và ảnh đại diện của tài khoản bếp.</p>
              </div>
              {!editing ? (
        ...
        <form className="kitchen-account-surface kitchen-account-security" onSubmit={submitPassword} noValidate>
          <header className="kitchen-account-security-head">
            ...
            <div>
              ...
              <p>Đổi mật khẩu định kỳ để bảo vệ tài khoản làm việc của bạn.</p>
            </div>
          </header>
        ...
        <section className="kitchen-account-surface waiter-alert-settings">
          <header className="kitchen-account-security-head">
            ...
            <div>
              ...
              <p>Bật cảnh báo để nhận âm thanh và thông báo nhắc việc khi có món mới hoặc công việc bếp cần xử lý.</p>
            </div>
          </header>
          ...
          <div className="waiter-alert-settings-body">
            <div className="waiter-alert-setting-row">
              <div>
                ...
                <p>Nhận cảnh báo khi có món mới vào bếp, món cần chế biến hoặc công việc bếp cần xử lý.</p>
              </div>
