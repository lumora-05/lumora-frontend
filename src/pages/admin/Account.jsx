...
export default function Account() {
  ...
  const name = profile?.hoTen || profile?.fullName || profile?.username || profile?.tenDangNhap || 'Quản trị viên';
  ...
  return (
    <section className="page kitchen-account-page admin-account-modern">
          ...
          <div className="kitchen-account-profile-content">
            <header className="kitchen-account-section-head">
              <div>
                ...
                <p>Quản lý thông tin liên hệ và ảnh đại diện của tài khoản quản trị.</p>
              </div>
              {!editing ? (
