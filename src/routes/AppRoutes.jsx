...
export default function AppRoutes(){return <Routes>
  ...
  <Route path="/admin" element={<ProtectedRoute roles={['ADMIN']}><AdminLayout/></ProtectedRoute>}>
    <Route index element={<AdminDashboard/>}/><Route path="employees" element={<EmployeeManage/>}/><Route path="tables" element={<TableManage/>}/><Route path="categories" element={<CategoryManage/>}/><Route path="menu" element={<MenuManage/>}/><Route path="inventory" element={<InventoryManage/>}/><Route path="promotions" element={<PromotionManage/>}/><Route path="orders" element={<AdminOrderManage/>}/><Route path="customers" element={<CustomerLoyaltyManage/>}/><Route path="reviews" element={<ReviewManage/>}/><Route path="reports" element={<Report/>}/><Route path="service-requests" element={<Navigate to="/admin" replace/>}/><Route path="cashier-shifts" element={<Navigate to="/admin" replace/>}/><Route path="reservations" element={<Navigate to="/admin/tables?tab=reservations" replace/>}/><Route path="account" element={<AdminAccount/>}/><Route path="settings" element={<SystemSettings/>}/>
  </Route>
