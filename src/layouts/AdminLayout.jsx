...
const pageMeta = {
  ...
  '/admin/orders': ['Đơn hàng', 'Theo dõi và xử lý đơn hàng của nhà hàng'],  '/admin/customers': ['Khách hàng thân thiết', 'Quản lý thông tin, điểm tích lũy và lịch sử giao dịch của khách hàng'],
...
export default function AdminLayout() {
  ...
  const items = [
    ...
    { to: '/admin/orders', label: 'Đơn hàng', icon: 'orders' },    { to: '/admin/customers', label: 'Khách hàng', icon: 'users' },
